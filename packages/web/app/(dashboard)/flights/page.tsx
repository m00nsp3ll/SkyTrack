          ...
          <CardContent className="p-4">
            {inFlight.length === 0 ? (
              ...
              <div className="space-y-3">
                {inFlight.map((flight) => (
                  <Link key={flight.id} href={`/admin/flights/${flight.id}`}>
                    <Card className={`cursor-pointer hover:shadow-md transition-shadow border-2 ${getFlightColor(flight.elapsedMinutes)}`}>
